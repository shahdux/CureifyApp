            ...
            >
                ...
                <motion.div className='progresstabs' variants={fadeUp} initial="hidden" whileInView="visible" transition={{ duration: 0.6, delay: 0.1 }} viewport={vp}>
                    <Link to="/progress" style={{ textDecoration: 'none' }}>
                        <button className='progresstab progresstabactive'>{isArabic ? "مكتملة" : "Completed"}</button>
                    </Link>
                ...
                <motion.div variants={fadeUp} initial="hidden" whileInView="visible" transition={{ duration: 0.6, delay: 0.15 }} viewport={vp}>
                    <MedicineCard2
                        image={pil}
                        name="Aspirin 100mg"
                        tablets={1}
