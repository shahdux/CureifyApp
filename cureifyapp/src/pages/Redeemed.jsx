    ...
    return (
        <>
            ...
            >
                ...
                <motion.p className='rewardssectionlabel' variants={fadeUp} initial="hidden" whileInView="visible" transition={{ duration: 0.6, delay: 0.2 }} viewport={vp}>
                    {isArabic ? "المكافآت المستبدلة" : "Redeemed Rewards"}
                </motion.p>

                <motion.div className='rewarditemcard' variants={fadeUp} initial="hidden" whileInView="visible" transition={{ duration: 0.6, delay: 0.25 }} viewport={vp}>
                    <div className='rewarditemleft'>
                        ...
                        <div className='rewarditeminfo'>
                            ...
                            <div className='rewardbottomrow'>
                                ...
                                <Link to="/reward-details" style={{ textDecoration: 'none' }}>
                                    <button className="pharmacydirectionsbtn viewwidth">{isArabic ? "عرض" : "View"}</button>
                                </Link>
                            </div>
                        </div>
                    </div>
